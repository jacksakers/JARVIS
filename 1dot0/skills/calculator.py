...
class CalculatorSkill(BaseSkill):
    name = "calculator"
    description = "Returns the result of a simple calculation. Use this when the user asks to add, subtract, multiply, or divide numbers."
    keywords = ["calculate", "calculation", "math", "add", "subtract", "multiply", "divide"]
    ...
    def execute(self, params: CalculatorInput) -> str:
        # detect the calculation in the user's query and evaluate it safely
        try:
